...
`cdh` is a smart shell function to manage and navigate your directory history with fuzzy search.  
It automatically tracks directories you visit and prevents duplicate subdirectories.
